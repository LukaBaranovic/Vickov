      ...
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:block">
          <a
            ...
            className="bg-green-500 text-white px-5 py-2 rounded-full font-bold hover:bg-green-600 transition flex items-center gap-2 shadow-md"
          >
            {/* WhatsApp Ikona */}
            <svg
